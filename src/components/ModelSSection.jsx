...
function ModelSSection({ products }) {
    return (
        <div>
            {products.filter(car => car.title === "Model S").map(filteredCar => (
                <section className="hero-section" key={filteredCar.id}
                    ...
                    <div className="hero-content">
                        ...
                        <div className="btn">
                            <Link to="OrderModelS"> <button className='left-btn v-btn'><LeftButton leftText="Order Now" /></button></Link>
